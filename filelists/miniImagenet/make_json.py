...
print(datadir)
data_path = '/home/d4090/ldq/mini-imagenet'
print(data_path)
savedir = './'
...
data_path_new = '/home/d4090/ldq/mini-imagenet/images/'
#print(len(classes))
   ...
   # mark = 0
    with open(datasetmap[dataset] + ".csv", "r") as lines:
        for i, line in enumerate(lines):
            ...
            fid = int(fid[-5:])-1
            # print('sorted_fnames:',len(sorted_fnames))
            # print('i:',i%600-1)
            if i%600-1 < len(sorted_fnames) :
